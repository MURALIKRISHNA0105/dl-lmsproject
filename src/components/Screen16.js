    ...
    return (
        <div>
            ...
            <div class="flex flex-col text-left">
                <div class="display-x">
                    <div class="float-left mt-10 ml-28">
                        <p class="text-sm text-[#555555]">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam<br></br> nonumy eirmod tempor invidunt ut labore et dolore magna <br></br>aliquyam erat, sed diam voluptua. At vero eos et accusam et justo<br></br> duo dolores et ea rebum. </p>
                    <p class="mt-10 text-sm text-[#555555]">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam<br></br>nonumy eirmod tempor invidunt</p>
                    </div>
                    <div class="float-left ml-36 mt-32">
                        <p class="text-md text-[#555555] mb-5">nonumy eirmod tempor invidunt</p>
                        <p class="text-sm text-[#555555]">Lorem ipsum dolor sit amet, consetetur <br></br>sadipscing elitr, sed diam nonumy <br></br>eirmod tempor invidunt.</p>
                    <button class="border-gray bg-[#4285F2] mt-10 text-white px-4 py-2">Submit assigments</button>
                    </div>
                </div>
            </div>
            <div>
