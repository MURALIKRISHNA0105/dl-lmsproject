...
const Screen23 = () => {
    return (
        <div>
            ...
            <div class="flex flex-col mt-24">
                <div class="display-x">
                    ...
                    <div class="float-left border-2 border-[#797979] border-opacity-20 ml-36 mb-20  ">
                        <form>
                           <h1 class="text-[#5D5D5D] mt-20 font-bold opacity-70 ">VERIFY CERTIFICATE</h1>

                            <input type="text" placeholder='Your Text' class="border-l-0 border-r-0 border-t-0 border-b-2 px-72 pl-0 mx-8 mr-28 mt-10" />
                            <br></br>
                            <br></br>
                            <input type="text" placeholder='Enter Text' class="border-l-0 border-r-0 border-t-0 border-b-2 px-72 pl-0 mx-8  mr-28" />
                           
                           
                            <br></br>
                            <br></br>
                            <button class="text-white bg-[#4285F2] px-10 py-2 mb-10 ml-8 float-center "> Verify</button>
            ...
            <div>
                <img style={{ width:200,height:250}}  class="ml-24 relative bottom-20" src='./images/sceen19.png' />
            </div>
        </div>
    )
}
