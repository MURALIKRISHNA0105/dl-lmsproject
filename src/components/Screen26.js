        ...
        <div>
            ...
            <div class=" flex flex-col  ">
                ...
                <div class="mt-32 float-left  ">
                    ...
                    <p class="text-[#636363] text-md font-bold relative float-left bottom-4  left-12 ">A front-end developer works with languages and framework</p>
                    <p class="text-[#636363] text-md  relative float-left -bottom-5 " style={{ right: 415 }}><BsXCircleFill color='red' size='25' class='  relative float-left mr-4  ' />HTML,CSS and Javascript</p>
            ...
            <div class='float-right mt-20'>
                <h1 class="inline-block mr-10 text-[#6F6F6F]">I'll Try it later</h1>
                <button class="border-2 bg-[#097BDF] px-8 py-2 text-white inline-block mr-10">Retry Again</button>
