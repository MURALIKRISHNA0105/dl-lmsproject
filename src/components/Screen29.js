        ...
        <div>
            ...
            <div class=" flex flex-col  ">
                ...
                <div class="mt-32 float-left ">
                   ...
                   <p class="relative float-left top-10  right-96 border-2 border-thin border-[#707070]  pr-56 pl-4 py-2 text-left"> <input  type="radio" name='name1' />HTML,CSS and PHP </p>
                   <p class="relative float-left   border-2 border-thin border-[#707070] pr-56 pl-4 py-2 text-left" style={{top:115,right:780}}>   <input type="radio" name='name1'  />HTML,CSS and Swift</p>
                   <p class="relative float-left    border-2 border-thin border-[#707070] pr-48 pl-4 py-2 text-left " style={{top:150,left:150}}>  <input type="radio" name='name1'  />HTML,CSS and JavaScript</p>
            ...
            <div class='float-right mt-52'>
                ...
                <button class=" text-[#097BDF] inline-block mr-10"><u>Next<IoIosArrowForward size={13} class="relative left-10 bottom-4  "/></u></button>
