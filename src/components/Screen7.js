...
const Screen7 = () => {
    return (
        <div>
            ...
            <hr class="mt-10 ml-20 " style={{ marginRight: 400 }}></hr>
            <div class="ml-36 mt-10 clear-left text-left"  >
                <img src='./images/user.png ' class="inline" />
                <p class="text-sm text-[#4C4C4C] inline ml-4">Write a Reply</p>
            </div>
            <hr class=" ml-48 mt-1 " style={{ marginRight: 600 }}></hr>
            <p class="text-sm text-[#5F5F5F] text-left ml-36 mt-5"><u>30Replys</u></p>
            <div class="ml-36 mt-10 clear-left text-left"  >
                <img src='./images/user.png ' class="inline" />
                <p class="text-sm text-[#4C4C4C] inline ml-4 font-bold">Ankit</p>
                <p class="text-sm text-[#4C4C4C]  ml-14">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor <br></br>invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et .</p>
            </div>
            
            <div class=" mt-5" >
                <TiArrowBack size='20' color='#4C4C4C' class="float-left ml-48 inline " />
                <p class="inline float-left text-[#4C4C4C] text-sm"> Reply</p>
               
            </div>
            <div class="ml-36  mt-20 clear-left text-left"  >
                <img src='./images/user.png ' class="inline" />
                <p class="text-sm text-[#4C4C4C] inline ml-4 font-bold">Suresh</p>
                <p class="text-sm text-[#4C4C4C]  ml-14">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor <br></br>invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et .</p>
            </div>
            
            <div class=" mt-5" >
                <TiArrowBack size='20' color='#4C4C4C' class="float-left ml-48 inline " />
                <p class=" float-left text-[#4C4C4C] text-sm"> Reply</p>
               
                
            </div>
            <p class="text-sm text-[#5F5F5F] text-left ml-36 mt-20 font-bold"><u>View all </u></p>
            <hr class="mt-10 ml-20 " style={{ marginRight: 400 }}></hr>
            <div class="ml-24 mt-10 clear-left text-left"  >
                <img src='./images/user.png ' class="inline" />
                <p class="text-md text-[#4C4C4C] inline ml-4">How To Upload file in AWS</p>
            ...
            <div>
                <div class="float-right mr-24 -mt-10 border-2 bg-[#E6BF02] px-4 py-2 rounded-full relative mb-52">

                    <p>Have a doubt? Rise a query</p>
                </div>
                <BsRecordCircle color='green' class="   relative  inline -mt-16 " style={{ left: 515 }} />
            </div>
